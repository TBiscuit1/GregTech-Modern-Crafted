...
public class GTMachines {
    ...
    public static final MultiblockMachineDefinition ELECTRIC_BLAST_FURNACE = REGISTRATE
            ...
            .tooltips(Component.translatable("gtceu.machine.electric_blast_furnace.tooltip.0", "900K"),
                    Component.translatable("gtceu.machine.electric_blast_furnace.tooltip.1", "1800K"),
                    Component.translatable("gtceu.machine.electric_blast_furnace.tooltip.2", "100K"))
        ...
        return REGISTRATE
                ...
                .tooltips(
                        Component.translatable("gtceu.multiblock.large_boiler.max_temperature",
                                convertTemperature((int) (maxTemperature + 274.15)), convertTemperature(maxTemperature)),
